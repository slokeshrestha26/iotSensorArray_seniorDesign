...
/*
 * Arguments    : const double xr[3800]
 *                creal_T x[3800]
 * Return Type  : void
 */
void hilbert(const double xr[3800], creal_T x[3800])
{
  ...
  static creal_T b_wwc[7599];
  static creal_T b_x[3800];
  static creal_T wwc[3799];
  static const double b_dv[4097] = {0.0,
                                    ...
                                    0.00076699031874270449,
                                    0.0};
  static const double sintabinv[4097] = {0.0,
                                         0.00076699031874270449,
                                         0.0015339801862847655,
                                         0.002300969151425805,
                                         0.0030679567629659761,
  ...
  for (k = 0; k < 1899; k++) {
    ...
    nt_im = -3.1415926535897931 * (double)rt / 1900.0;
    if (nt_im == 0.0) {
      nt_re = 1.0;
      nt_im = 0.0;
    } else {
  ...
  for (k = 0; k < 3799; k++) {
    ...
    nt_im = 3.1415926535897931 * (double)rt / 3800.0;
    if (nt_im == 0.0) {
      nt_re = 1.0;
      nt_im = 0.0;
    } else {
    ...
    b_wwc[3798 - k].re = nt_re;
    b_wwc[3798 - k].im = -nt_im;
  }
  for (k = 3798; k >= 0; k--) {
    b_wwc[k + 3800] = b_wwc[3798 - k];
  }
  for (k = 0; k < 3800; k++) {
    b_x[k] = x[k];
    d = b_wwc[k + 3799].re;
  ...
  for (rt = 0; rt < 8192; rt++) {
    fv[rt].re *= 0.0001220703125;
    fv[rt].im *= 0.0001220703125;
  }
  for (k = 0; k < 3800; k++) {
    d = b_wwc[k + 3799].re;
    d1 = b_wwc[k + 3799].im;
    twid_re = fv[k + 3799].re;
    twid_im = fv[k + 3799].im;
